#!/usr/bin/env node
/**
 * profiles RLS 무한 재귀 수정 SQL을 클립보드에 복사하고 Supabase SQL 에디터를 엽니다.
 */
...
const sqlPath = join(__dirname, '../supabase/migrations/20250310020000_fix_profiles_rls_recursion.sql');
...
try {
  ...
  console.log('[완료] profiles RLS 수정 SQL이 클립보드에 복사되었습니다.');
