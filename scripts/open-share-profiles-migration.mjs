#!/usr/bin/env node
/**
 * 프로젝트 공유 시 담당자도 전체 승인 회원 목록을 볼 수 있도록 하는
 * profiles SELECT 정책(SQL)을 클립보드에 복사하고 Supabase SQL 에디터를 엽니다.
...
const sqlPath = join(__dirname, '../supabase/migrations/20260313130000_profiles_select_all_approved_for_share.sql');
...
try {
  ...
  console.log('[완료] 공유용 회원 목록 정책 SQL이 클립보드에 복사되었습니다.');
