#!/usr/bin/env node
/**
 * projects 테이블 주간보고용 컬럼(report_agency 등) 추가 SQL을 클립보드에 복사하고
 * Supabase SQL 에디터를 엽니다. PGRST204(report_agency 없음) 오류 해결용.
...
const sqlPath = join(__dirname, '../supabase/migrations/20260313110000_add_projects_report_fields.sql');
...
try {
  ...
  console.log('[완료] 주간보고용 컬럼 추가 SQL이 클립보드에 복사되었습니다.');
