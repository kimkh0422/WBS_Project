  ...
  const indentTask = useCallback(
    (id: string) => {
      ...
      setAllTasks((prev) => {
        ...
        return recomputeProjectRollups([...otherTasks, ...updated], cpi, undefined, undefined, false);
      });
    },
    [saveHistory, setAllTasks, currentProjectIdRef],
  );
  ...
  const indentTasks = useCallback(
    (ids: string[]) => {
      ...
      setAllTasks((prev) => {
        ...
        return recomputeProjectRollups([...otherTasks, ...projectTasks], cpi, undefined, undefined, false);
      });
    },
    [saveHistory, setAllTasks, currentProjectIdRef],
  );
  ...
  const moveTaskRootsSibling = useCallback(
    (orderedRootIds: string[], overId: string, position: 'before' | 'after') => {
      ...
      setAllTasks((prev) => {
        ...
        return recomputeProjectRollups([...otherTasks, ...merged], cpi, undefined, undefined, false);
      });
    },
    [saveHistory, setAllTasks, currentProjectIdRef],
  );
