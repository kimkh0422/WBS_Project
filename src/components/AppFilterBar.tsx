...
import { ChevronDown, Flag, Bug, Clock, X, User } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[var(--color-bg)] border border-[var(--color-line)]">
        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider" title="마일스톤/이슈 기준으로 작업을 필터링합니다.">
          마일스톤
        </span>
        <div className="flex flex-wrap items-center gap-1.5">
          <button
