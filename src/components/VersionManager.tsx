  ...
  return [
    {
      version: '0.3.0',
      date: '2026-03-17',
      changes: ['투입 현황·대시보드에서 인원별로 프로젝트당 몇 M/D(공수)가 투입되었는지 확인할 수 있습니다.'],
    },
    {
      version: '0.3.13',
      date: '2026-03-18',
      changes: ['로그인만 하면 관리자 승인 없이도 서버(DB)에 자동 저장·동기화됩니다.', 'Ctrl+S 즉시 반영·첫 접속 동기화는 동일합니다.'],
    },
    {
      version: '0.3.12',
      date: '2026-03-18',
      changes: [
        'DB 동기화 버튼을 없애고, 승인 사용자는 편집 후 자동으로 서버에 반영됩니다. 다른 편집자 변경은 Realtime으로 표시됩니다.',
        'Ctrl+S는 대기 없이 즉시 서버 반영입니다.',
        '첫 접속 시 전체 맞춤 동기화(토스트)는 그대로입니다.',
      ],
    },
    {
      version: '0.2.4',
    ...
    },
    {
      ...
      changes: [
        ...
        'Excel/JSON 가져오기·내보내기를 사용할 수 있습니다.',
      ],
    },
  ];
}
