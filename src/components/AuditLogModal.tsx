...
export function AuditLogModal({ isOpen, onClose, projectId, projectName }: AuditLogModalProps) {
                  ...
                  return (
                    <tr key={entry.id} className="border-b border-stone-100 hover:bg-stone-50/50">
                      ...
                      <td className="py-2 px-2">
                        <span
                          className={entry.action === 'delete' ? 'text-red-600' : entry.action === 'create' ? 'text-green-600' : 'text-stone-700'}
                        >
