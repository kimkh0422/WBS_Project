  ...
  },
  {
    ...
    content: [
      ...
      { type: 'subtitle', text: '작업 추가·레벨 변경' },
      {
        type: 'list',
        items: [
          '작업명 클릭(또는 F2): 표에서 바로 이름 수정 — Enter로 저장·종료. 그 외 표에 포커스가 있을 때 Enter: 같은 레벨(형제)로 아래에 새 작업. Shift+Enter 또는 Shift+Insert: 같은 레벨로 위에 추가. Insert: 선택한 행의 하위 작업 추가.',
    ...
    content: [
      {
        ...
        rows: [
          ...
          ['표', 'Insert', '선택한 행의 하위에 빈 작업 추가(행 접혀 있으면 펼침)'],
          ['표', 'Shift+Insert', '같은 레벨 위에 새 작업 추가(Shift+Enter와 동일)'],
