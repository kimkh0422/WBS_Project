...
const TUTORIAL_SECTIONS: TutorialSection[] = [
  ...
  },
  {
    ...
    content: [
      {
        type: 'paragraph',
        text: '관리자 승인을 받은 사용자는 편집 내용이 잠시 후 자동으로 서버에 올라갑니다. 같은 프로젝트를 연 다른 사람의 수정은 Supabase Realtime으로 거의 바로 화면에 반영됩니다.',
      },
      {
        type: 'list',
        items: [
          'Ctrl+S를 누르면 대기 없이 곧바로 서버에 반영합니다(자동 저장과 같은 방식, 더 빠르게 올리고 싶을 때).',
